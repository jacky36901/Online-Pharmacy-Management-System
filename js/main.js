...
//   var cust_fname=jQuery("#cust_fname").val();
//   var cust_lname=jQuery("#cust_lname").val();
//   var cust_num=jQuery("#cust_num").val();
//   var cust_house=jQuery("#cust_house").val();
//   var cust_city=jQuery("#cust_city").val();
//   var cust_state=jQuery("#cust_state").val();
//   var cust_pin=jQuery("#cust_pin").val();
...
//   is_error='yes';
// }if (cust_house=="") {
//   jQuery('#house_error').html('Please enter house name');
//   is_error='yes';
// }if (cust_city=="") {
//   jQuery('#city_error').html('Please enter city name');
//   is_error='yes';
// }if (cust_state=="") {
//   jQuery('#state_error').html('Please enter state name');
//   is_error='yes';
// }if (cust_pin=="") {
//   jQuery('#pin_error').html('Please enter pin');
//   is_error='yes';
// }if (username=="") {
...
//     type:'post',
//     data:'cust_fname='+cust_fname+'&cust_lname='+cust_lname+'&cust_num='+cust_num+'&cust_house='+cust_house+'&cust_city='+cust_city+'&cust_state='+cust_state+'&cust_pin='+cust_pin+'&username='+username+'&password='+password,
...
function user_login(){
  ...
  var is_error='';
if (username=="") {
  jQuery('#login_email_error').html('Please enter username');
  is_error='yes';
}if (password=="") {
