...
$count6 = $row6['count6'];
$result = mysqli_query($con,"SELECT COUNT(*) AS `count7` FROM `tbl_order_master` where Order_status='Approved.Waiting for dispatch'");
...
<div class="content pb-0">
   <div class="orders">
    ...
    <div class="col-md-3">
      ...
      <div class="card-counter info">
        <i class="fa fa-users"></i>
        <span class="count-numbers"><?php echo $count7;
                ?></span>
        <span class="count-name">ACTIVE ORDERS</span>
      </div>
    </div>
    <br>
    <br>
