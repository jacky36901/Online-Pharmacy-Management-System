...
$sql="SELECT * FROM `tbl_purchase_child` WHERE status='check' order by Cpurchase_id desc";
	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">MEDICINES REPORT</h4>
				   
                      <h4 class="box-link"><a href="expiry.php">back</a></h4>
